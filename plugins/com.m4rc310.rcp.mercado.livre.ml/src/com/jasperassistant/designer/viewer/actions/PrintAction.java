...
public class PrintAction extends AbstractReportViewerAction {
	...
	private static final ImageDescriptor DISABLED_ICON = ImageDescriptor.createFromFile(PrintAction.class,
			"images/printd.gif"); //$NON-NLS-1$
...
////			            printJob.setPrintService(getReportViewer().getDocument());
//
...
//			            exporter.exportReport();
					...
					MessageDialog.openError(display.getActiveShell(),
							...
							MessageFormat.format(Messages.getString("PrintAction.printingError.message"), //$NON-NLS-1$
	 ...
	 * 
	 * @param file The file to export the PDF to.
	 * @throws JRException if there are problems exporting the Report to a PDF.
	 * 
	 * @since 03.05.2005
	 */
	 ...
	 * 
	 * @param file The PDF to open.
	 * @throws IOException If the PDF can not be found.
	 * 
	 * @since 03.05.2005
	 */
